...
func TestMatchCards(t *testing.T) {
	...
	tests := []struct {
		...
		{"negation", "!t:creature", []string{"Bolt", "Sword", "Enchant"}},
		{"negation with AND", "!t:creature cmc<=2", []string{"Bolt", "Enchant"}},
		{"negated group", "!(t:creature OR t:instant)", []string{"Sword", "Enchant"}},
